...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val description = intent.getStringExtra(EXTRA_DESCRIPTION) // Pour r̩trocompatibilit̩
        val representativeColorHex = intent.getStringExtra(EXTRA_REPRESENTATIVE_COLOR_HEX) // R̩tablir l'extraction de la couleur
        ...
        if (imageUriString != null && localName != null && scientificName != null) {
            currentEntry = AnalysisEntry(
                ...
                description = description ?: "N/C", // Assurer une valeur par d̩faut
            ...
            Toast.makeText(this, "Erreur: Donn̩es de r̩sultat manquantes.", Toast.LENGTH_LONG).show()
            finish()
        }
    ...
    private fun displayResult(entry: AnalysisEntry) {
        ...
        // Afficher le badge de type et appliquer la couleur repr̩sentative
                ...
                entry.representativeColorHex?.let { colorHex ->
                    if (colorHex.startsWith("#") && colorHex.length == 7) {
                        try {
                            ...
                            resultTypeBadge.setBackgroundResource(R.drawable.badge_nc) // Couleur par d̩faut en cas d'erreur
                        }
                    } else {
                        resultTypeBadge.setBackgroundResource(R.drawable.badge_nc) // Couleur par d̩faut si le format est incorrect
                    }

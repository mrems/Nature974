...
class ConfidenceAndAlternativesFragment : Fragment() {
    ...
    // Couleurs du dÃ©gradÃ© pour la barre de progression (doivent correspondre Ã  custom_progress_bar.xml)
    ...
    override fun onCreateView(
        ...
        analysisEntry?.let { entry ->
            ...
            if (entry.isTutorial) {
                ...
                entry.alternativeIdentifications?.let { alternatives ->
                    if (alternatives.isNotEmpty()) {
                        ...
                        // Afficher le subtitle adaptÃ© au nombre d'alternatives
            ...
            // GÃ©rer le cas oÃ¹ analysisEntry est null
            confidenceCard.visibility = View.GONE
            alternativesSection.visibility = View.GONE
            tutorialExplanationTextView.visibility = View.GONE
        }
    ...
    /**
     * Interpole une couleur entre la couleur de dÃƒÂ©but et la couleur de fin en fonction d'une progression (0-100).
     */

...
class PeculiaritiesFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            danger = it.getBoolean(ARG_DANGER, false) // R̩cup̩rer la valeur du danger
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        // Afficher le texte d'explication du tutoriel dans le contenu de la carte si disponible, sinon les particularit̩s normales.
